---
bio: My research interests are reconstructing a large scale phylogeny to explore the diversity patterns in angiosperms across space and time using big biological data and biological comparative methods.
education:
  courses:
...
- display:
  ...
  icon: twitter
  icon_pack: fab
  link: https://twitter.com/Miao_the_Sun
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.co.uk/citations?user=E5fIHlgAAAAJ&hl=zh-CN
- icon: orcid
  icon_pack: ai
  link: https://orcid.org/0000-0001-5701-0478
- icon: researchgate
  icon_pack: ai
  link: https://www.researchgate.net/profile/Miao_Sun
- icon: github
  icon_pack: fab
  link: https://github.com/Cactusolo
superuser: true
title: Miao Sun | 孙苗
---
